...
bipartiteGibbs_withSeed <- function(cd, Z_known, nIter=1000, a=1, b=1, aBM=1, bBM=1, seed=0){
  ...
  dyn.load("~/Documents/Duke University/Bayesian Record Linkage (with Dr. Reiter)/BayesianRecordLinkage/helper_fns/helper_fns_C/BRLGibbsWithSeed.so")
  
  out <- .C("BayesianRecordLinkageWithSeed", 
            ...
            Z_known=as.integer(Z_known), # known bipartite matching, coded as integers
